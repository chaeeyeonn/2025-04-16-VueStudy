   ...
   <table class="table">
     <tr>
      ...
      <td width=85%>
       <input type=text name=name size=20 required
        class="input-sm" value="${vo.name }" ref="name" v-model="name"
       >
     ...
     <tr>
      ...
      <td width=85%>
       <input type=text name=subject size=50 required
        class="input-sm" value="${vo.subject }" ref="subject" v-model="subject"
       >
      </td>
     </tr>
     <tr>
     ...
     <tr>
       <td colspan="2" align=center>
         <input type=submit value="수정하기" class="btn-sm btn-danger">
