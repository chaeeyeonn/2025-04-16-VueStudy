	     ...
	     data(){
	    	 return{
	    		 sawon:[
	    			 ...
	    			 {"sabun":2,"name":"심청이","sex":"여자","dept":"기획부","loc":"경기"},
	    			 {"sabun":3,"name":"이순신","sex":"남자","dept":"영업부","loc":"부산"},
	    			 {"sabun":4,"name":"김두한","sex":"남자","dept":"생산부","loc":"울산"},
	    			 {"sabun":5,"name":"박문수","sex":"남자","dept":"연구부","loc":"인천"}
	    		 ],
	    		 isShow:false
	    		 detail_data:{}
	    	 }
