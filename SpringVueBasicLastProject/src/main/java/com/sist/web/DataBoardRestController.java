...
import com.sist.dao.*;
import com.sist.vo.*;
// Vue/React는 여기서 해결 => Spring-Boot
// yml 사용 방식 익히기(설정 파일) => 들여쓰기 주의
@RestController
public class DataBoardRestController {
	...
	public String databoardListData(int page) throws Exception
	{
		Map map=new HashMap();
	...
	public String databoardInsertOK(DataBoardVO vo)
	{
		...
		try
		{
			...
			else
			{
				...
				{
					String name=mf.getOriginalFilename(); // 사용자가 보낸 파일이름
